...
export function kaynakca() {
  ...
  d.appendChild(el('p', 'meta', 'inkbee içeriğinin kaynağı ve çalışma yöntemi - MLA biçiminde.'));
  ...
  k4.innerHTML = `
    <p class="citenote"><b>Yazılım:</b> inkbee, nosey-dewdrop tarafından geliştirilir. Hesap ve eşitleme altyapısı: Supabase (Frankfurt/AB veri merkezi). Yazı tipi: Arial (sistem yazı tipi). Analitik, reklam ve izleme aracı kullanılmaz - ayrıntı için <a href="gizlilik.html">gizlilik sayfası</a>.</p>`;
  d.appendChild(k4);
}
